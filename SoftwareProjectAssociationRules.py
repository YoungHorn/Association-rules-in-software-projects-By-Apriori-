# -*- coding: utf-8 -*-
"""
Created on Mon Nov  5 20:52:53 2018
...
def generateRules():
    ...
    getFinalListQuery = "SELECT tag1, tag2, tag3, num_projs FROM test.fc_project_tag_triples"
...
print("Minium support count:", minsupport, "(", MINSUPPORTPCT, "% of", baskets, ")")
